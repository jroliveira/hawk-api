namespace Hawk.Domain.Tag.Data.Neo4J
{
    ...
    {
        private static readonly Option<string> Statement = ReadCypherScript(Combine("Tag", "Data.Neo4J", "GetTags.cql"));
        ...
        public Task<Try<Page<Try<Tag>>>> GetResult(Option<Email> email, Filter filter) => email.Match(
            async some =>
            {
                var parameters = new
                {
