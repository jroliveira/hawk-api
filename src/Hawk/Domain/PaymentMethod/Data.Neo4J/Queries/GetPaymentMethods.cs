namespace Hawk.Domain.PaymentMethod.Data.Neo4J.Queries
{
    ...
    internal sealed class GetPaymentMethods : Query<GetAllParam, Page<Try<PaymentMethod>>>, IGetPaymentMethods
    {
        private static readonly Option<string> StatementOption = ReadCypherScript(Combine("PaymentMethod", "Data.Neo4J", "Queries", "GetPaymentMethods.cql"));
        ...
        protected override async Task<Try<Page<Try<PaymentMethod>>>> GetResult(GetAllParam param)
        {
            var parameters = new
            {
