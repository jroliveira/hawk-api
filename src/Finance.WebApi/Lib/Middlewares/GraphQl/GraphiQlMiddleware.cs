namespace Finance.WebApi.Lib.Middlewares.GraphQl
{
    ...
    public sealed class GraphiQlMiddleware
    {
        ...
        public GraphiQlMiddleware(RequestDelegate next)
        {
            this.next = next ?? throw new ArgumentNullException(nameof(next));
            this.graphiqlPath = "/graphiql";
...
";
        ...
        {
            return string.Equals(request.Method, "GET", StringComparison.OrdinalIgnoreCase) && request.Path.StartsWithSegments(this.graphiqlPath);
        }
